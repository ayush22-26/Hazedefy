            ...
            <div className="mt-5 sm:flex md:mt-8">
              ...
              {file && (
                <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                  <button
                    className="flex items-center justify-center w-full px-8 py-3 text-base font-medium leading-6 text-primary transition duration-150 ease-in-out bg-secondary border border-transparent rounded-md cursor-pointer  focus:outline-none focus:shadow-outline-blue md:py-4 md:text-lg md:px-10"
                    onClick={uploadFile}
                  >
                    Upload Image
                  </button>
